		...
		` : html`
			<div class="icon-container">
				<svg xmlns="http://www.w3.org/2000/svg" width="6" height="10.01" viewBox="0 0 6 10.01">
					<path id="LeftArrow" d="M9.714,4.29l-4-4A1.012,1.012,0,0,0,4.3.29l-4,4A1,1,0,0,0,1.021,6H9.014a1,1,0,0,0,.7-1.71Z" transform="translate(0 10.01) rotate(-90)" fill="#565a5c"/>
				</svg>
			</div>
		`;
	}
