...
export const d2lTableStyles = css`
	...
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-first > .d2l-table-cell-first:not(.d2l-table-cell-last) {
		border-top-left-radius: 0;
	}
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table-row-first > .d2l-table-cell-first,
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-first > .d2l-table-cell-first {
	...
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-first > .d2l-table-cell-last:not(.d2l-table-cell-first) {
		border-top-right-radius: 0;
	}
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table-row-first > .d2l-table-cell-last,
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-first > .d2l-table-cell-last {
		border-top-left-radius: var(--d2l-table-border-radius);
	}
	...
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-last > .d2l-table-cell-first:not(.d2l-table-cell-last) {
		border-bottom-left-radius: 0;
	}
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table-row-last > .d2l-table-cell-first,
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-last > .d2l-table-cell-first {
	...
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-last > .d2l-table-cell-last:not(.d2l-table-cell-first) {
		border-bottom-right-radius: 0;
	}
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table-row-last > .d2l-table-cell-last,
	:host([dir="rtl"]) d2l-table[type="default"] .d2l-table-row-last > .d2l-table-cell-last {
		border-bottom-left-radius: var(--d2l-table-border-radius);
	}
	...
	:host([dir="rtl"]) d2l-table[type="default"] d2l-tbody > d2l-tr[selected] > .d2l-table-cell-first {
	...
	:host([dir="rtl"]) d2l-table[type="default"] d2l-tbody > d2l-tr[selected] > .d2l-table-cell-last {
	...
	:host([dir="rtl"]) d2l-table[type="default"] d2l-tbody > d2l-tr[active][selected] > .d2l-table-cell-first,
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table[selectable] > tbody > tr[selected]:hover > .d2l-table-cell-first,
	:host([dir="rtl"]) d2l-table[type="default"][selectable] d2l-tbody > d2l-tr[selected]:hover > .d2l-table-cell-first {
	...
	:host([dir="rtl"]) d2l-table[type="default"] d2l-tbody > d2l-tr[active][selected] > .d2l-table-cell-last,
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table[selectable] > tbody > tr[selected]:hover > .d2l-table-cell-last,
	:host([dir="rtl"]) d2l-table[type="default"][selectable] d2l-tbody > d2l-tr[selected]:hover > .d2l-table-cell-last {
		border-right-color: var(--d2l-table-border-color);
	}
	...
	:host([dir="rtl"]) d2l-table[type="default"][no-column-border] d2l-tbody > d2l-tr > .d2l-table-cell-last {
		border-right: none;
	}
	:host([dir="rtl"]) d2l-table-wrapper[type="default"] .d2l-table[no-column-border] > tbody > tr > .d2l-table-cell-first,
	:host([dir="rtl"]) d2l-table[type="default"][no-column-border] d2l-tbody > d2l-tr > .d2l-table-cell-first {
		border-right: var(--d2l-table-border);
	}
	/* sticky-headers */
